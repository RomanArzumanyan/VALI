...
class PySurfaceRotator:
    ...
    @overload
    def __init__(self, gpu_id: int, stream: int) -> None: ...
    def Run(self, angle: float, shift_x: float = ..., shift_y: float = ..., src: Surface, dst: Surface) -> tuple[bool, TaskExecInfo]: ...
    def RunAsync(self, angle: float, shift_x: float = ..., shift_y: float = ..., src: Surface, dst: Surface, record_event: bool = ...) -> tuple[bool, TaskExecInfo, CudaStreamEvent]: ...
