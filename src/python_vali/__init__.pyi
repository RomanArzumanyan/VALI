...
class CudaStreamEvent:
    def __init__(self, stream: int, gpu_id: int) -> None: ...
...
class DecodeStatus:
    __members__: ClassVar[dict] = ...  # read-only
    DONE: ClassVar[DecodeStatus] = ...
    ERROR: ClassVar[DecodeStatus] = ...
    MORE: ClassVar[DecodeStatus] = ...
    OVER: ClassVar[DecodeStatus] = ...
    RES_CHANGE: ClassVar[DecodeStatus] = ...
    SUCCESS: ClassVar[DecodeStatus] = ...
    __entries: ClassVar[dict] = ...
    def __init__(self, value: int) -> None: ...
    def __eq__(self, other: object) -> bool: ...
    def __hash__(self) -> int: ...
...
class PyDecoder:
    @overload
    def __init__(self, input: str, opts: dict[str, str], gpu_id: int = ..., pkt_queue_size: int = ...) -> None: ...
    @overload
    def __init__(self, buffered_reader: object, opts: dict[str, str], gpu_id: int = ..., pkt_queue_size: int = ...) -> None: ...
    def DecodePacketToFrame(self, frame: numpy.ndarray) -> DecodeStatus: ...
    def DecodePacketToSurface(self, surf) -> DecodeStatus: ...
    def DecodePacketToSurfaceAsync(self, surf) -> DecodeStatus: ...
    @overload
    ...
    @overload
    def DecodeSingleSurfaceAsync(self, surf, seek_ctx: SeekContext | None = ...) -> tuple[bool, TaskExecInfo]: ...
    @overload
    def DecodeSingleSurfaceAsync(self, surf, pkt_data: PacketData, seek_ctx: SeekContext | None = ...) -> tuple[bool, TaskExecInfo]: ...
    @staticmethod
    def Probe(input: str) -> list[StreamParams]: ...
    def ReadPacket(self) -> DecodeStatus: ...
...
class PyNvEncoder:
    ...
    @overload
    def EncodeSingleSurface(self, surface, packet: numpy.ndarray, sei: numpy.ndarray, sync: bool, append: bool) -> bool: ...
    @overload
    def EncodeSingleSurface(self, surface, packet: numpy.ndarray, sei: numpy.ndarray, sync: bool) -> bool: ...
    @overload
    def EncodeSingleSurface(self, surface, packet: numpy.ndarray, sync: bool) -> bool: ...
    @overload
    def EncodeSingleSurface(self, surface, packet: numpy.ndarray, sei: numpy.ndarray) -> bool: ...
    @overload
    def EncodeSingleSurface(self, surface, packet: numpy.ndarray) -> bool: ...
    def Flush(self, packets: numpy.ndarray) -> bool: ...
    def FlushSinglePacket(self, packets: numpy.ndarray) -> bool: ...
...
class PySurfaceConverter:
    ...
    def RunAsync(self, src, dst, cc_ctx: ColorspaceConversionContext | None = ...) -> tuple[bool, TaskExecInfo]: ...
    @property
    def Stream(self) -> int: ...
...
class PySurfaceResizer:
    ...
    def RunAsync(self, src, dst) -> tuple[bool, TaskExecInfo]: ...
    @property
    def Stream(self) -> int: ...
...
class PySurfaceRotator:
    ...
    def RunAsync(self, src: Surface, dst: Surface, angle: float, shift_x: float = ..., shift_y: float = ...) -> tuple[bool, TaskExecInfo]: ...
    @property
    def Stream(self) -> int: ...
    @property
...
class PySurfaceUD:
    ...
    def RunAsync(self, src: Surface, dst: Surface) -> tuple[bool, TaskExecInfo]: ...
    @staticmethod
...
def SetFFMpegLogLevel(level: FfmpegLogLevel) -> None: ...
