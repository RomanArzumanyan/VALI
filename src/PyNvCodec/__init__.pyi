...
class PyFfmpegDecoder:
    ...
    @overload
    def DecodeSingleFrame(self, frame: numpy.ndarray[numpy.uint8], pktData: PacketData) -> tuple[bool, TaskExecInfo]: ...
    def DecodeSingleSurface(self, *args, **kwargs): ...
    def Format(self) -> PixelFormat: ...
    def Framerate(self) -> float: ...
...
class PyFrameConverter:
    ...
    def Execute(self, src: numpy.ndarray, dst: numpy.ndarray, cc_ctx: ColorspaceConversionContext) -> tuple[bool, TaskExecInfo]: ...
    def Format(self) -> PixelFormat: ...
...
class PyFrameUploader:
    ...
    @overload
    def __init__(self, width: int, height: int, format: PixelFormat, stream: int) -> None: ...
    def Format(self) -> PixelFormat: ...
    def UploadSingleFrame(self, *args, **kwargs): ...
...
class PyNvDecoder:
    ...
    def DecodeSingleSurface(self, *args, **kwargs): ...
    def DecodeSurfaceFromPacket(self, *args, **kwargs): ...
    @overload
    ...
    def FlushSingleSurface(self, *args, **kwargs): ...
    def Format(self) -> PixelFormat: ...
    def Framerate(self) -> float: ...
...
class PySurfaceConverter:
    ...
    @overload
    def __init__(self, width: int, height: int, src_format: PixelFormat, dst_format: PixelFormat, stream: int) -> None: ...
    def Execute(self, src, dst, cc_ctx: ColorspaceConversionContext) -> tuple[bool, TaskExecInfo]: ...
    def Format(self) -> PixelFormat: ...
...
class PySurfaceDownloader:
    ...
    @overload
    def __init__(self, width: int, height: int, format: PixelFormat, stream: int) -> None: ...
    def DownloadSingleSurface(self, surface, frame: numpy.ndarray) -> bool: ...
    def Format(self) -> PixelFormat: ...
