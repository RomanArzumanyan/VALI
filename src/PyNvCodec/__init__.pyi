...
class PyDecoder:
    ...
    def DecodeSingleFrame(self, frame: numpy.ndarray, pkt_data: PacketData | None = ..., seek_ctx: SeekContext | None = ...) -> tuple[bool, TaskExecInfo]: ...
    def DecodeSingleSurface(self, surf, pkt_data: PacketData | None = ..., seek_ctx: SeekContext | None = ...) -> tuple[bool, TaskExecInfo]: ...
